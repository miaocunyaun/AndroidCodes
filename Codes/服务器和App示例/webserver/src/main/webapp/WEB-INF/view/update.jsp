...
<body>
<h1>修改书本信息</h1>
	<form class="form-horizontal" action="<c:url value="/update.html"/>"
		method="post">
		<input name="id" value="${oldbook.id}" style="display:none;">
		<div class="form-group">
			<label for="name"
				class="col-xs-2 col-sm-2 col-md-2 col-lg-1 control-label">书名</label>
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="name" class="form-control placeholder-no-fix" value="${oldbook.name}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="author" class="form-control placeholder-no-fix" value="${oldbook.author}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="binfo" class="form-control placeholder-no-fix" value="${oldbook.binfo}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="auinfo" class="form-control placeholder-no-fix" value="${oldbook.auinfo}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="collects" class="form-control placeholder-no-fix" value="${oldbook.collects}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="rewards" class="form-control placeholder-no-fix" value="${oldbook.rewards}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="publish" class="form-control placeholder-no-fix" value="${oldbook.publish}"
		...
		<div class="form-group">
			...
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-5">
				<input name="words" class="form-control placeholder-no-fix" value="${oldbook.words}"
